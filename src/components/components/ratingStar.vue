<template>
  <div class="start" :style="{'--size': size}">
    <div class="start-bottom">
      <div class="start-top" :style="{'width': topWidth}"></div>
    </div>
  </div>
</template>
<script>
...
/**
 * fileName: 'ratingStar.vue'
 * createTime: 2018-07-12   14:02
 * @params: { param: mean
 * @desc: 评分星星组件
 *        图片的宽高比为5.6： 1
 */
...
.start{
  ...
  &-bottom{
    ...
    background-size: calc(var(--size) * 5.6) var(--size);
